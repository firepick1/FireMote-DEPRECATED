...
directives.directive('fireHref', ['$interpolate', function($interpolate) {
	return {
	  restrict:'A',
		compile: function compile(tElt, tAttrs, transclude) {
		  return {
			  pre: function (scope, elm, attrs) {
					...
					scope.$watch(attrs.fireHref, function(value) {
						console.log("fire-href watch:" + value);
						elm.attr('href', value);
					})
				}
			};
...
directives.directive('d3Bars', ['d3', function(d3) {
      return {
        restrict: 'EA',
        scope: {
          data: "=",
